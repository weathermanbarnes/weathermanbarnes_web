...
indir='/scratch/gb02/mb0427/Website/Forecasts/NOAA/GEFS/'
webdir='data/NOAA/GEFS/'

htmlpath='/g/data/gb02/mb0427/Website/Forecasts/ops_scripts/GFS/'
input_html_path = htmlpath+'forecast_GEFS_default.html'  # Replace with the path to your input file
output_html_file='forecast_GEFS.html'
...
check_file_path = indir+"copy_GEFS_data.check"
