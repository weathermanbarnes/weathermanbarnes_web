...
for t in trange:
    ...
    cb.set_label('Wind Speed [kt]', rotation=0, fontsize=15)
    
    outfile=outpath+'images/GEFS_'+name+'_'+'PostageUpper_'+str(t)+'.jpg'
    plt.savefig(outfile, dpi=300)
    crop(outfile,in_padding=50)
    #plt.show()

    check_file_path = outpath+"plot_GEFS_Upper_t"+str(t)+".check"
