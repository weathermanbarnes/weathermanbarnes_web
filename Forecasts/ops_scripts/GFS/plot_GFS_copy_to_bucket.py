...
home_path = os.getcwd()+"/"
indir=home_path+'scratch/GFS/'
webdir='data/NOAA/GFS/'

input_html_path = home_path+'forecast_GFS_default.html'  # Replace with the path to your input file
output_html_file='forecast_GFS.html'
...
check_file_path = indir+"copy_GFS_data_"+set_hemisphere+".check"
